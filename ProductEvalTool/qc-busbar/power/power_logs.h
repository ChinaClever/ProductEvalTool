...
public:
    ...
    void writeData(const QString &str, const QString &str2, const QString &str3, bool pass=true, int send=1);
    void writeDataEng(const QString &str1,const QString &str2, const QString &str3, bool pass, int send=1);
protected:
    bool writeLog();
    void writeLogs();
